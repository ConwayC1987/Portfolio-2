...
Game Area: <details>
           ...
           <p>The user is given a clock that gives the user 10 seconds to answer, when the time gets to 7 seconds the clock starts to flash red warning the user. The idea for the time gauge and progress circles part of the website was taken from https://www.youtube.com/watch?v=49pYIMygIcU and changed to suit the project.</p>
         </details>
